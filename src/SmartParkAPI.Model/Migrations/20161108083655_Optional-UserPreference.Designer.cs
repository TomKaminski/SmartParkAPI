...
namespace SmartParkAPI.Model.Migrations
{
    ...
    [Migration("20161108083655_Optional-UserPreference")]
    partial class OptionalUserPreference
    {
            ...
            modelBuilder.Entity("SmartParkAPI.Model.Concrete.User", b =>
                {
                    ...
                    b.Property<int?>("UserPreferencesId1");
                    ...
                    b.HasIndex("UserPreferencesId1")
                        .IsUnique();

                    b.ToTable("User");
                });

            modelBuilder.Entity("SmartParkAPI.Model.Concrete.UserDevice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SmartParkAPI.Model.Concrete.User", b =>
                {
                    ...
                    b.HasOne("SmartParkAPI.Model.Concrete.UserPreferences", "UserPreferences")
                        .WithOne("User")
                        .HasForeignKey("SmartParkAPI.Model.Concrete.User", "UserPreferencesId1")
                        .OnDelete(DeleteBehavior.Cascade);
                });
